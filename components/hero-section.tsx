...
// Removed unused icon imports to satisfy lint rules
import { Reveal } from "./reveal"
// BlurPanel intentionally unused (commented UI); import removed to avoid lint error
        ...
        <div className="container-custom text-center text-white">
          <Reveal>
            <h1 className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold leading-none tracking-tight mb-6">
              <AnimatedText text="Design OutFit for" delay={0.5} />
              <br />
              <span className="italic font-light">
                <AnimatedText text="vibe you get." delay={1.1} />
              </span>
            </h1>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            ...
            >
              Elevate your style with our suggested curated collection of outfits that blend comfort, quality, and timeless design.
            </motion.p>
          </Reveal>
        </div>
      </motion.div>
